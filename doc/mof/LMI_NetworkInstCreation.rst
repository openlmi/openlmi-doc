...
LMI_NetworkInstCreation notifies when a new instance of one of the following classes is created: LMI_IPAssignmentSettingData and LMI_IPNetworkConnection.
